...
class Command(BaseCommand):
    ...
    products = [
        ...
        ("Paithani Lehenga", "Lehenga", "Saree House"),
        ("Banarasi Lehenga", "Lehenga", "Saree House"),
        ("Rajasthani Lehenga", "Lehenga", "Saree House"),
        ("Kanjeevaram Lehenga", "Lehenga", "Saree House"),
        ("Fabric-Based Lehengas", "Lehenga", "Saree House"),

        # T-Shirt (Men Clothing → T-Shirt)
        ("Crew Neck T-Shirt", "T-Shirt", "Nike"),
        ("V-Neck T-Shirt", "T-Shirt", "Nike"),
        ("Round Neck T-Shirt", "T-Shirt", "Adidas"),
        ("Polo T-Shirt", "T-Shirt", "Polo"),
        ("Scoop Neck T-Shirt", "T-Shirt", "Puma"),
